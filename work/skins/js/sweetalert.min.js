!function (n, t) {
    ...
    var n = {
        ...
        a = e(["success", "warning", "info", "question", "error"]), s = "SweetAlert2:", r = function (n) {
        ...
        }, f = u({}, n), m = [], b = void 0, g = void 0, h = function (n) {
            for (var t in n) v.isValidParameter(t) || r('Unknown parameter "' + t + '"'), v.isDeprecatedParameter(t) && c('The parameter "' + t + '" is deprecated and will be removed in the next major release.')
        }, x = function (n) {
            ...
            var t = void 0, e = P(), s = "string" == typeof n.target ? document.querySelector(n.target) : n.target;
            ...
            for (var l = window.getComputedStyle(t).getPropertyValue("background-color"), c = t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), p = 0; p < c.length; p++) c[p].style.backgroundColor = l;
            var w = E(), u = z(), d = j().querySelector("#" + o.content), f = Z(), m = Y(), b = R(), g = H(), h = D();
            ...
            var k = V(), y = parseInt(null === n.currentProgressStep ? v.getQueueStep() : n.currentProgressStep, 10);
            ...
            if ("undefined" != typeof window) {
                ...
                return new Promise(function (t, e) {
                    ...
                    for (var f = function (t) {
                        ...
                        var e = t || window.event, o = e.target || e.srcElement, a = Y(), i = R(),
                            c = a && (a === o || a.contains(o)), p = i && (i === o || i.contains(o));
                        switch (e.type) {
                            case"click":
                                if (c && n.isVisible()) if (n.disableButtons(), s.input) {
                                    var w = function () {
                                        var n = u();
                                        if (!n) return null;
                                        switch (s.input) {
                                ...
                                } else f(!0); else p && n.isVisible() && (n.disableButtons(), r(n.DismissReason.cancel))
                        }
                    }, v = m.querySelectorAll("button"), S = 0; S < v.length; S++) v[S].onclick = h, v[S].onmouseover = h, v[S].onmouseout = h, v[S].onmousedown = h;
                    ...
                    s.toast && g && (window.onkeydown = b, g = !1), s.toast || g || (b = window.onkeydown, g = !0, window.onkeydown = function (t) {
                        ...
                        if ("Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                            for (var o = e.target || e.srcElement, a = M(s.focusCancel), i = -1, l = 0; l < a.length; l++) if (o === a[l]) {
                                i = l;
                                break
                            }
                            e.shiftKey ? $(i, -1) : $(i, 1), e.stopPropagation(), e.preventDefault()
                        } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === T && en(I) ? I.focus() : document.activeElement === I && en(T) && T.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== p(s.allowEscapeKey) || r(n.DismissReason.esc); else if (e.target === u()) {
                    ...
                    for (var _ = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], tn = void 0, on = 0; on < _.length; on++) {
                        var sn = o[_[on]], rn = J(B, sn);
                        if (tn = u(_[on])) {
                            for (var ln in tn.attributes) if (tn.attributes.hasOwnProperty(ln)) {
                                var cn = tn.attributes[ln].name;
                                "type" !== cn && "value" !== cn && tn.removeAttribute(cn)
                            }
                            for (var pn in s.inputAttributes) tn.setAttribute(pn, s.inputAttributes[pn])
                        }
                        rn.className = sn, s.inputClass && Q(rn, s.inputClass), nn(rn)
                    }
                    var wn, un, dn, fn, mn, bn = void 0;
                    switch (s.input) {
                        case"text":
                        case"email":
                        case"password":
                        ...
                        case"file":
                            ...
                            break;
                        case"range":
                            var gn = J(B, o.range), hn = gn.querySelector("input"), xn = gn.querySelector("output");
                        ...
                        case"select":
                            ...
                            bn = function (n) {
                                n.forEach(function (n) {
                                    var t = d(n, 2), e = t[0], o = t[1], a = document.createElement("option");
                        ...
                        case"radio":
                            var vn = J(B, o.radio);
                            vn.innerHTML = "", bn = function (n) {
                                n.forEach(function (n) {
                                    var t = d(n, 2), e = t[0], a = t[1], r = document.createElement("input"),
                            ...
                            break;
                        case"checkbox":
                            var Cn = J(B, o.checkbox), Sn = u("checkbox");
    ...
    }, v.version = "7.12.15", v.default = v, "undefined" != typeof window && "object" === w(window._swalDefaults) && v.setDefaults(window._swalDefaults);
    var C = {previousActiveElement: null, previousBodyPadding: null}, S = function () {
            ...
            if (t && (t.parentNode.removeChild(t), F([document.documentElement, document.body], [o["no-backdrop"], o["has-input"], o["toast-shown"]])), !S()) {
                ...
                var a = P(), s = j(), r = J(s, o.input), l = J(s, o.file), c = s.querySelector("." + o.range + " input"),
        ...
        E = function () {
            ...
            if (!n) return nn(t);
            if ("object" === (void 0 === n ? "undefined" : w(n))) if (t.innerHTML = "", 0 in n) for (var e = 0; e in n; e++) t.appendChild(n[e].cloneNode(!0)); else t.appendChild(n.cloneNode(!0)); else n && (t.innerHTML = n);
            G(t)
        }, X = function () {
            ...
            for (var e = 0; e < n.childNodes.length; e++) if (W(n.childNodes[e], t)) return n.childNodes[e]
        }, G = function (n) {
